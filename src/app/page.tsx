...
const faqs = [
  {
    ...
    a: "Extremely secure. Your authentication is isolated via better-auth protocols. Tokens are fully sandboxed on our Corsair multi-tenant architecture, meaning your access scopes are strictly confined to your terminal slice and revocable at any millisecond.",
  },
  {
    q: "Can I connect multiple Google Workspaces?",
    a: "Yes. With the Overclocked Pro ($45) and Enterprise Shard ($99) tiers, you can link cross-domain Google identities and orchestrate drafts/events globally across multiple profiles seamlessly.",
  },
  {
    q: "What is the Corsair Engine?",
...
export default function LandingPage() {
  ...
  const [events, setEvents] = useState<
    Array<{ time: string; title: string; status: string; active: boolean }>
  >([
    {
      time: "09:00",
  ...
  function toggleEventActive(idx: number) {
    setEvents((e) =>
      e.map((ev, i) =>
        i === idx
          ? {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                background: "var(--lime)",
                boxShadow: "0 0 16px rgba(200,241,53,0.25)",
              }}
            >
              <svg
                className="w-4 h-4"
            ...
            <span
              className="text-xs font-extrabold tracking-widest uppercase font-mono"
              style={{ color: "var(--text-primary)" }}
            >
              Inbox Commander
            </span>
      ...
      <section
        ...
        style={{ background: "rgba(200,241,53,0.01)" }}
      >
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {techSpecs.map((spec) => (
            <div key={spec.label} className="font-mono">
              <div className="text-xl md:text-2xl font-extrabold text-[var(--lime)]">
                {spec.metric}
              </div>
              <div className="text-[9px] uppercase tracking-widest mt-1 opacity-50">
                {spec.label}
              </div>
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto space-y-14">
          <div className="text-center space-y-3">
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              Built for speed. No clutter, no bloat — just the controls that
              matter.
            </p>
          </div>
      ...
      <section
        ...
        style={{ background: "rgba(8,13,5,0.2)" }}
      >
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              No tab switching. Draft high-importance communications while
              holding the context of your calendar nodes.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 items-start font-mono text-[11px]">
            ...
            <div
              className="lg:col-span-7 rounded-2xl border border-[var(--border)] p-6 space-y-4"
              style={{ background: "var(--bg-card)" }}
            >
              <div className="flex items-center justify-between border-b border-[var(--border)] pb-3">
                <span className="text-[10px] font-extrabold tracking-widest uppercase text-[var(--lime)]">
              ...
              <div className="space-y-3">
                <div>
                  <div className="block opacity-40 uppercase tracking-wider text-[9px] mb-1">
                    To:
                  </div>
                  <input
                    value={to}
                    onChange={(e) => setTo(e.target.value)}
                    className="w-full px-3 py-2 rounded bg-[var(--bg-surface)] border border-[var(--border)] opacity-90 text-[11px]"
                  />
                </div>
                <div>
                  <div className="block opacity-40 uppercase tracking-wider text-[9px] mb-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded bg-[var(--bg-surface)] border border-[var(--border)] text-[var(--lime)] text-[11px]"
                  />
                </div>
                <div>
                  <div className="block opacity-40 uppercase tracking-wider text-[9px] mb-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-3 rounded bg-[var(--bg-surface)] border border-[var(--border)] opacity-80 min-h-[100px] text-[11px]"
                  />
                </div>
              </div>
              <div className="flex justify-between items-center gap-2 pt-2">
                <div className="text-[10px] opacity-60">
                  Staged: {stagedDrafts.length}
                </div>
                <div className="flex justify-end gap-2">
                  <button
                    onClick={handlePurge}
                    className="px-3 py-1.5 rounded border border-[var(--border)] text-[var(--text-muted)] hover:text-[var(--text-primary)] transition"
                  >
                    PURGE
                  </button>
                  <button
                    onClick={handleStageDraft}
                    className="px-4 py-1.5 rounded font-extrabold uppercase bg-[var(--lime)] text-[var(--bg-base)] shadow-[0_0_15px_rgba(200,241,53,0.2)]"
                  >
                    STAGE DRAFT
                  </button>
                </div>
            ...
            <div
              className="lg:col-span-5 rounded-2xl border border-[var(--border)] p-6 space-y-4"
              style={{ background: "var(--bg-card)" }}
            >
              <div className="flex items-center justify-between border-b border-[var(--border)] pb-3">
                <span
                ...
                {events.map((slot, index) => (
                  <div
                    ...
                    className={`p-3 rounded border transition cursor-pointer ${
                      slot.active
                        ? "border-[var(--lime)] bg-[rgba(200,241,53,0.02)]"
                        : "border-[var(--border)] opacity-60"
                    }`}
                  >
                    <div className="flex justify-between items-center font-bold">
                      <span className={slot.active ? "text-[var(--lime)]" : ""}>
                        {slot.time}
                      </span>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl border border-dashed border-[rgba(200,241,53,0.4)] text-[var(--lime)] hover:bg-[rgba(200,241,53,0.03)] transition font-bold uppercase tracking-wider text-[10px]"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center">
            <div className="space-y-3 md:col-span-1">
              ...
              <p
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                Designed exclusively for operators who treat email management
                and calendar alignments as critical runtime operations.
              </p>
            </div>

            <div className="md:col-span-2 grid sm:grid-cols-2 gap-5 font-mono text-[11px]">
              <div
                className="p-5 rounded-xl border border-[var(--border)] space-y-2"
                style={{ background: "var(--bg-card)" }}
              >
                <div className="text-[var(--lime)] font-extrabold uppercase tracking-widest">
                  Webhooks Pipeline
                </div>
                <p className="opacity-70 leading-relaxed text-[10px]">
                  Pipe inbound Gmail triggers into webhooks. Feed your local
                  automations or messaging vectors dynamically.
                </p>
              </div>
              <div
                className="p-5 rounded-xl border border-[var(--border)] space-y-2"
                style={{ background: "var(--bg-card)" }}
              >
                <div className="text-[var(--text-primary)] font-extrabold uppercase tracking-widest">
                  Isolated Sandbox
                </div>
                <p className="opacity-70 leading-relaxed text-[10px]">
                  Encryption parameters utilize isolated environment variables
                  per tenant profile layer. Zero cross-leakage.
                </p>
              </div>
              <div
                className="p-5 rounded-xl border border-[var(--border)] space-y-2"
              ...
              >
                ...
                <p className="opacity-70 leading-relaxed text-[10px]">
                  Map native vim or customized hotkeys directly inside your
                  workspace browser context for lightning execution.
                </p>
              </div>
              <div
                className="p-5 rounded-xl border border-[var(--border)] space-y-2"
              ...
              >
                ...
                <p className="opacity-70 leading-relaxed text-[10px]">
                  Data flows in state transitions. Your full email body blocks
                  are never permanently indexed in our disk logs.
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        id="pricing"
        className="px-6 py-24 border-t border-b border-[var(--border)]"
              ...
              return (
                <div
                  ...
                  className={`relative p-6 rounded-2xl flex flex-col justify-between transition-all duration-300 border ${
                    tier.popular ? "md:scale-[1.05] z-10 shadow-2xl" : ""
                  }`}
                  style={{
                    background: "var(--bg-card)",
                    borderColor: tier.popular ? color.border : "var(--border)",
                    boxShadow: tier.popular
                      ? `0 0 40px ${color.accent}30`
                      : "none",
                  }}
                >
                  {tier.popular && (
                    <div
                      className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1.5 text-[8px] tracking-widest font-extrabold uppercase rounded-full font-mono"
                      style={{
                  ...
                  <div className="pt-8">
                    <Link
                      href="/signup"
                      className={`w-full flex items-center justify-center py-3 rounded-xl text-[10px] font-extrabold uppercase tracking-widest transition-all duration-200 ${
                        tier.popular
                          ? "text-[var(--bg-base)] active:scale-[0.97]"
                          : "border border-[var(--border)] text-[var(--text-primary)] hover:border-[rgba(200,241,53,0.4)] active:scale-[0.97]"
                      }`}
                      style={{
                        background: tier.popular ? color.accent : "transparent",
                        boxShadow: tier.popular
                          ? `0 0 20px ${color.accent}40`
                          : "none",
                      }}
                    >
                      {tier.cta}
            ...
            {[
              {
                ...
                desc: "Sign up with your email or connect instantly with Google OAuth.",
              },
              {
                step: "02",
                title: "Connect Google",
                desc: "Authorize Gmail and Calendar access — scoped, secure, revocable.",
              },
              {
                step: "03",
                title: "Take Command",
                desc: "Manage emails and events from a single, distraction-free dashboard.",
              },
            ].map(({ step, title, desc }) => (
              <div
                key={step}
              ...
              >
                <span
                  className="text-5xl font-extrabold font-mono opacity-10 absolute top-4 right-5 leading-none"
                  style={{ color: "var(--lime)" }}
                >
                  {step}
                </span>
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className="p-6 rounded-xl border border-[var(--border)] space-y-2"
                style={{ background: "var(--bg-card)" }}
              >
      ...
      >
        <div className="max-w-2xl mx-auto text-center space-y-6">
          <h2
            className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight leading-tight"
            style={{ color: "var(--text-primary)" }}
          >
      ...
      <footer className="px-6 pt-16 pb-8 border-t border-[var(--border)] bg-[#040703]/95 font-mono text-[11px]">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            <div className="col-span-2 space-y-4">
              ...
              <p
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                The high-density terminal interface built to unify enterprise
                communication streams and workspace coordination layers. Blazing
                speed meets autonomous context tracking.
              </p>
            ...
            <div className="space-y-3">
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-[var(--lime)] block">
                AI Core Layer
              </span>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className="group flex items-center gap-1">
                    <span className="opacity-0 group-hover:opacity-100 text-[var(--lime)] transition-opacity">
                      &middot;
                    </span>
            ...
            <div className="space-y-3">
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-[var(--text-primary)] block">
                Command Hub
              </span>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item}>
                    <a
                      ...
                      className="hover:text-[var(--text-primary)] opacity-60 hover:opacity-100 transition-opacity block"
                    >
                      &gt; {item}
                    </a>
                  </li>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-[10px]">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-1.5 opacity-50 hover:opacity-80 transition-opacity cursor-default"
                  >
          ...
          <div
            className="flex flex-col md:flex-row items-center justify-between gap-6 text-[10px]"
            style={{ color: "var(--text-muted)" }}
          >
            <div className="space-y-1 text-center md:text-left">
              <div>
                © {new Date().getFullYear()} Inbox Commander Inc. Matrix
                connection: encrypted telemetry.
              </div>
              <div className="opacity-50 text-[9px]">
                Engineered with Next.js 16 · better-auth engine · Google API
                Zero-Cache compliance certified.
              </div>
            </div>

            <div className="hidden lg:flex items-center gap-6 font-mono opacity-40 text-[9px]">
              <div>
                LOC: {Intl.DateTimeFormat().resolvedOptions().timeZone || "UTC"}
              </div>
              <div>
                TZ: UTC/
